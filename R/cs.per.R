#implementation of the formulas of zhang for any support of x

#' @export
cs.per=function(x, knots=NULL, nk=5, xmax=max(x, na.rm=TRUE), xmin=min(x, na.rm=TRUE)){
  
  #x: numeric vector
  #knots: vecotor with knot locations
  #nk: number of knots, overridden if knots are provided
  #mxax: value of the end of the cycle
  #mxax: value of the beginning of the cycle
