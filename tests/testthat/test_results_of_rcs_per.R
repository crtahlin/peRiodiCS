context("Test results of rcs.per() function")

# generate results to test
rcs.per_result1 <- rcs.per(seq(0, 1, by = 0.001), nk = 5)
rcs.per_result2 <- rcs.per(seq(0, 1, by = 0.001), nk = 8)
set.seed(12345) # set seed for reproducible result - set.seed(12345)
rcs.per_result3 <- rcs.per(runif(1000), nk = 5)
