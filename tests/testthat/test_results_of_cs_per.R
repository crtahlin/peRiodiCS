context("Test results of cs.per() function")

# generate results to test
cs.per_result1 <- cs.per(x = seq(0, 1, by = 0.001), knots = 5)
cs.per_result2 <- cs.per(seq(0, 1, by = 0.001), knots = 8)
set.seed(12345) # set seed for reproducible result - set.seed(12345)
cs.per_result3 <- cs.per(runif(1000), knots = 5)
